...
#define dfs_cache_noreq_find(path, ref) \
	__dfs_cache_find(0, NULL, NULL, 0, path, ref)
#define dfs_cache_find(xid, ses, nc, remap, path, ref) \
	__dfs_cache_find(xid, ses, nc, remap, path, ref)
...
#define dfs_cache_noreq_inval_tgt(tree, ref) \
	__dfs_cache_inval_tgt(0, NULL, NULL, 0, tree, ref)
